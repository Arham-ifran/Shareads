...
<h1 class="signup_heading">Become a Publisher today  <a href="#" type="button" class="btn btn-secondary toltip_btn test" data-toggle="tooltip" data-placement="bottom" title="<?php echo P_TEXT ?>"><i class="fa fa-question-circle" aria-hidden="true"></i></a></h1>
                <div id="signup_form">
                    <div class="row">
