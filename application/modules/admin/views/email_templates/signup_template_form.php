...
<div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-9">
                            <div class="clearfix">
                            <textarea class="col-xs-12 col-sm-5" id="welcome_content" name="welcome_content"  placeholder="Welcome Content" required><?php echo $welcome_content ?></textarea>
                        </div></div>
                    </div>
                <div class="space-2"></div>
<?php }?>
...
<div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-9">
                    <div>
                        <label class="blue">
                            <input type="radio" id="" class="ace" <?php echo ($status == 1) ? 'checked' : '' ?> value="1" name="status" required>
                            <span class="lbl">&nbsp;Active</span>
                        </label>
                    </div>
                    <div>
                        <label class="blue">
                            <input type="radio" class="ace" <?php echo ($status == 0) ? 'checked' : '' ?> id="" value="0" name="status" required>
