...
<div class="row">
    <div class="col-xs-12">
        ...
        <?php if (!in_array($_SERVER['REMOTE_ADDR'], $whitelist)): ?>
            <?php $form_action = ($action == 'add')? $this->uri->segment(3) : 'add_publisher'; ?>
        <?php else: ?>
    <?php $form_action = $this->uri->segment(4); ?>
<?php endif; ?>
        <form id="users_form" name="users_form" action="<?php echo base_url('admin/users/' . $form_action) ?>" class="form-horizontal" role="form" method="post" autocomplete="off"  accept-charset="utf-8" enctype="multipart/form-data">
...
<?php if ($form_action <> 'add_publisher_with_invitation'): ?>
                <div class="space-2"></div>
                <div class="form-group">
                    <label class="control-label col-xs-12 col-sm-3 no-padding-right">Paypal Email</label>
                    <div class="col-xs-12 col-sm-9">
                        <div class="clearfix">
    <?php /* onchange="varfyPaypalEmail();" */ ?>
                            <input type="email" class="col-xs-12 col-sm-5" id="paypal_email" name="paypal_email" value="<?php echo $row['paypal_email'] ?>"   placeholder="Paypal Email" />
                            <br><br>
...
<?php endif; ?>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix">
                        ...
                        <input type="email" class="col-xs-12 col-sm-5" id="email" name="email" value="<?php echo $row['email'] ?>"  placeholder="Email"  onchange="checkUsersEmail();" required/>
                        <br><br>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix">
                        ...
                        <input type="password" minlength="6"  class="col-xs-12 col-sm-5 ckeditor" id="password" name="password"  placeholder="Password" <?php echo (!isset($row)) ? 'required' : 'required' ?>/>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix">
                        <select id="country" name="country" class="col-xs-12 col-sm-5" required>
...
<?php } ?>
             ...
             */ ?>
<?php
//if ($form_action <> 'add_publisher_with_invitation') {
?>
            <div class="form-group">
