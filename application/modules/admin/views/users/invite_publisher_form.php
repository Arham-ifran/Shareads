...
<div class="row">
    <div class="col-xs-12">
        ...
        <form id="formEmail" action="<?php echo base_url('admin/users/add_publisher_invitations') ?>" class="form-horizontal" role="form" method="post" accept-charset="utf-8">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix">
                        <input  type="text" class="col-xs-12 col-sm-5" id="email_title" name="email_title"  placeholder="Welcome to Share Ads" value="<?php echo INVITATION_DEFAULT_TITLE; ?>" required ></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix">
                        <textarea class="col-xs-12 col-sm-5 ckeditor" id="email_content" name="email_content"  placeholder="Content" required><?php echo INVITATION_DEFAULT_CONTENT; ?></textarea>
                    </div></div>
            </div>
