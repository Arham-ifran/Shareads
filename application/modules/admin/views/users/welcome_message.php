...
<div class="breadcrumbs ace-save-state" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Publisher Welcome Message</li>
    </ul><!-- /.breadcrumb -->
...
<div class="row">
    <div class="col-xs-12">
        ...
        <form id="formEmail" action="<?php echo base_url('admin/users/send_welcome_email') ?>" class="form-horizontal" role="form" method="post" accept-charset="utf-8">
