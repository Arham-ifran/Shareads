...
<div class="row">
    <div class="col-xs-12">
        ...
        <form class="form-inline" role="form" id="searchListing" method="post" action="<?php echo base_url('admin/reports/advertiser_commissions') ?>">
    ...
    <div class="col-sm-8">
        ...
        {
            ?>
            <a  class="btn btn-info"  target="_blank" href="<?php echo base_url('admin/reports/print_advertiser_commissions_report') ?>"> Print Report</a>
        <?php } ?>
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="table-header"> Results for "All Advertiser Commissions"</div>
            ...
            <tbody>
                ...
                foreach ($result->result() as $row)
                {
                    ...
                    <tr>
                        ...
                        <td><?php echo getSiteCurrencySymbol(); ?><?php echo number_format(get_currency_rate($row->advertiser_commission, $row->p_cy, CURRENCY), 2); ?></td>
                        <td><?php echo date('d M, Y', $row->created); ?></td>
                        <?php
                        $total = $total + get_currency_rate($row->advertiser_commission, $row->p_cy, CURRENCY);
                        ?>
                ...
                jQuery(function () {
                    try {
                        $('.table').dataTable({
                            ...
                            buttons: [
                                {
                                    title: 'Advertiser Commission Report | ShareAds Admin Panel',
