...
<div class="row">
    <div class="col-xs-12">
        ...
        <form class="form-inline" role="form" id="searchListing" method="post" action="<?php echo base_url('admin/reports/admin_commissions') ?>">
...
<div class="clearfix space-8"></div>
    <div class="col-sm-8">
        ...
        {?>
                <a  class="btn btn-info"  target="_blank" href="<?php echo base_url('admin/reports/print_admin_commissions_report') ?>"> Print Report</a>
        <?php }?>
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="table-header"> Results for "All Admin Commissions"</div>
        <table id="dynamic-table" class="table table_unique table-striped table-bordered table-hover">
...
<script>
                jQuery(function () {
                    try {
                        $('.table_unique').dataTable({
                            dom: '<"top"B<"clear">f>rt<"bottom"lp><"clear">',
                            buttons: [
                                {
                                    title: 'Admin Commission Report | ShareAds Admin Panel',
