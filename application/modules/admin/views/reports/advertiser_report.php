...
<div class="row">
    <div class="col-xs-12">
        ...
        <form class="form-inline" role="form" id="searchListing" method="post" action="<?php echo base_url('admin/reports/advertiser') ?>">
    ...
    <div class="col-sm-8">
        ...
        {
            ?>
            <a  class="btn btn-info"  target="_blank" href="<?php echo base_url('admin/reports/print_advertiser_report') ?>"> Print Report</a>
<?php } ?>
                ...
                jQuery(function () {
                    try {
                        $('.table').dataTable({
                            ...
                            buttons: [
                                {
                                    title: 'Advertiser Report | ShareAds Admin Panel',
