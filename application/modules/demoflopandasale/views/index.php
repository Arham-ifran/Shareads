...
<html>
    <head>
        ...
        <script type="text/javascript"> window._pfq = window._pfq || [];(function() {var pf = document.createElement("script");pf.type = "text/javascript"; pf.async = true;pf.src = "//www.flopanda.com/v1/website/script/5cb43748ce94c03f324b03be";document.getElementsByTagName("head")[0].appendChild(pf);})();</script>
    </head>
    <body>

        <h2>FloPanda Demo Site (For QA Testing)</h2>
        <p>This site is not for official checkout and purchase</p>
        <div class="row">
            <div class="col-75">
                <div class="container">
                    <form action="<?php echo base_url('demoflopandasale/success'); ?>" method="get">
                        ...
                        <label>
                            <input type="checkbox" checked="checked" name="sameadr" disabled> Shipping address same as billing
                        </label>
